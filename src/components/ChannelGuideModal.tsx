...
const whatsappGuide = {
  ...
  beforeStart: {
    ...
    items: [
      ...
      "Отдельный номер телефона для WhatsApp Business (второй мобильный, городской или виртуальный номер). Рекомендуем НЕ использовать личный номер.",
      "Если вы используете свой личный номер — он отключится от обычного WhatsApp на телефоне и будет работать только через Staffix.",
    ],
  },
  steps: [
    {
