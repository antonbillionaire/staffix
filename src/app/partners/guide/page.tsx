      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          {[
            ...
            {
              crm: "Любая CRM / учётная система",
              flow: "AI-сотрудник в WhatsApp → обрабатывает предзаказы, отвечает на вопросы по наличию → данные передаются в систему клиента через универсальный webhook",
              value: "«AI-консьерж для розницы без разработки с нуля, поверх существующей системы»",
            },
          ].map((item) => (
