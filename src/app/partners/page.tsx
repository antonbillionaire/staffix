...
const benefits = [
  ...
  },
  {
    ...
    desc: "Staffix — AI-сотрудник в WhatsApp/Telegram, который дополняет вашу CRM, а не заменяет её. Удобно встраивать клиентам интеграторов CRM и учётных систем.",
    color: "text-blue-400",
    bg: "bg-blue-500/10",
  },
  {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              ...
              "Интеграторы CRM и учётных систем",
