 ...
 *                                    update_rate, update_notes, update_payout, mark_agreement
 */
    ...
    switch (action) {
      case "approve": {
        ...
        sendPartnerWelcomeEmail({
          ...
          referralCode,
          accessToken,
          commissionRatePercent: Math.round(updated.commissionRate * 100),
      ...
      case "update_payout": {
        ...
        const { cardNumber, cardHolder, bankName, payoutNotes } = body;
        await prisma.partner.update({
          where: { id },
          data: {
      ...
      case "resend_welcome_email": {
        ...
        await sendPartnerWelcomeEmail({
          ...
          commissionRatePercent: Math.round(partner.commissionRate * 100),
        });
        return NextResponse.json({ success: true });
      }
