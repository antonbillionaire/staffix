    ...
    <div className="min-h-screen bg-[#0a0a1a] flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="relative z-10 mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-[#12122a] py-8 px-6 rounded-2xl border border-white/5 sm:px-10">
          {/* Trial banner */}
          <div className="mb-6 bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20 rounded-xl p-4 flex items-center gap-3">
            <Sparkles className="h-5 w-5 text-yellow-400 flex-shrink-0" />
            <p className="text-sm text-gray-300">
              <span className="text-white font-medium">14 дней бесплатно</span> — попробуйте AI-сотрудника без оплаты
            </p>
          </div>
          ...
          >
            ...
            {googleLoading ? "Регистрация..." : "Продолжить с Google"}
          </button>
          ...
          <div className="mt-6 relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-3 bg-[#12122a] text-gray-500">или по email</span>
            </div>
          </div>
