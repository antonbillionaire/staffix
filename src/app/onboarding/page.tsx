...
const businessTypes: BusinessType[] = [
  ...
  { id: "restaurant", nameKey: "onboarding.type.restaurant", icon: UtensilsCrossed },
  { id: "flowers", nameKey: "onboarding.type.flowers", icon: Flower2 },
  { id: "repair", nameKey: "onboarding.type.repair", icon: Wrench },
  { id: "real_estate", nameKey: "onboarding.type.realEstate", icon: Building2 },
  { id: "travel", nameKey: "onboarding.type.travel", icon: Plane },
  { id: "photo_video", nameKey: "onboarding.type.photoVideo", icon: Camera },
  { id: "legal", nameKey: "onboarding.type.legal", icon: Scale },
