...
Всегда отвечай на том же языке, на котором в последнем сообщении написал клиент — русский, узбекский (латиница или кириллица), казахский, английский. Определяй язык клиента заново на каждое его сообщение. Узбекский на кириллице использует буквы русского алфавита + ў, қ, ғ, ҳ — не путай его с русским. Если сообщение слишком короткое чтобы определить язык (одно слово «ок», эмодзи) — используй язык бизнеса.`;
