...
` : ""}## ДЛИНА ОТВЕТА — ЖЁСТКИЙ ЛИМИТ
Максимум 400 символов на ответ. НИКОГДА не пиши больше. Обычно 1–2 коротких предложения. Люди в мессенджерах не читают простыни — если написать длинно, клиент не дочитает и переспросит.
Если клиент хочет подробностей — ответь коротко на его текущий вопрос, следующим сообщением он попросит уточнить и ты добавишь.
