...
Если хотите переназначить уже существующего клиента другому менеджеру — откройте карточку клиента в **Клиенты** и поменяйте «Менеджер».
...
Кнопка «Управление картой» → открывается личный кабинет PayPro. Логинитесь email-ом который использовали при покупке → меняете карту прямо там → подписка продолжает работать.
...
**Update card:** "Manage payment method" → opens PayPro customer portal where you can log in and update.
